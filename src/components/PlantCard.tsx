...
import { ShoppingCart, Star, CheckCheck } from "lucide-react";
    ...
    >
      <CardContent className="p-0">
        ...
        <div className="p-4">
          ...
          <p className="font-medium text-leaf-700 mb-2">₹{price}</p>
          ...
          >
            <div className="pt-2 pb-3 space-y-2">
              ...
              <div>
                <p className="text-xs font-medium text-leaf-700 mb-1">Care Level:</p>
                <p className="text-xs text-muted-foreground">{careLevel}</p>
              </div>
            </div>
          </motion.div>
