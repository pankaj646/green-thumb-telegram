...
import { 
  Leaf, Gift, Clock, User, ShoppingBag, Calendar, Truck, Heart, 
  Package, Star, Sparkle, TreesIcon, Flower, FlowerIcon, TreePine, 
  FerrisWheel, FolderHeart, Sprout, Shovel, FlameIcon
} from "lucide-react";
